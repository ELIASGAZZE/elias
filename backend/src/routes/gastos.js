...
router.post('/cierres/:cierreId/gastos', verificarAuth, async (req, res) => {
  try {
...
router.get('/cierres/:cierreId/gastos', verificarAuth, async (req, res) => {
  try {
    const { data: cierre, error: errorCierre } = await supabase
      .from('cierres')
...
router.put('/gastos/:id/controlar', verificarAuth, soloGestorOAdmin, async (req, res) => {
  try {
...
router.delete('/gastos/:id', verificarAuth, async (req, res) => {
  try {
    const { data: gasto, error: errorGasto } = await supabase
      .from('gastos')
