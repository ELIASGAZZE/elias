...
const APPS = [
  ...
  },
  {
    id: 'preparacion',
    nombre: 'Preparación',
    descripcion: 'Preparar órdenes de traspaso',
    path: '/preparacion',
    color: 'bg-teal-600',
    icono: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    id: 'reparto',
    nombre: 'Reparto',
    descripcion: 'Escaneo y despacho de canastos',
    path: '/reparto',
    color: 'bg-purple-600',
    icono: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    id: 'recepcion',
    nombre: 'Recepción',
    descripcion: 'Recepción y control de canastos',
    path: '/recepcion',
    color: 'bg-teal-600',
    icono: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
const APPS_ADMIN_GESTOR = [
  ...
  },
  {
    id: 'traspasos',
    nombre: 'Traspasos',
    descripcion: 'Órdenes de traspaso entre sucursales',
    path: '/traspasos',
    color: 'bg-sky-600',
    icono: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
const APPS_ADMIN = [
  {
    id: 'compras',
    nombre: 'Compras',
    descripcion: 'Compras inteligentes con IA',
    path: '/compras',
    color: 'bg-amber-600',
    icono: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    descripcion: 'Ventas, preguntas y reclamos',
    path: '/mercadolibre',
    color: 'bg-yellow-500',
    icono: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
