  ...
  <div class="footer-zone">
    <div class="footer-left">
      ...
      <div class="cajero-info">
        ...
        ${(pedido.cobrado_por || (pedido.cobrado_at && pedido.mp_payment_id)) ? `<br>Cobrado por: ${esc(pedido.cobrado_por || 'Talo Pay')}${pedido.cobrado_en_cierre ? ` (Caja #${pedido.cobrado_en_cierre})` : ''}${pedido.cobrado_sucursal_nombre ? ` - ${esc(pedido.cobrado_sucursal_nombre)}` : ''}${pedido.cobrado_at ? ` - ${new Date(pedido.cobrado_at).toLocaleString('es-AR', { day: '2-digit', month: '2-digit', year: '2-digit', hour: '2-digit', minute: '2-digit' })}` : ''}${pedido.pagos && Array.isArray(pedido.pagos) ? ` (${pedido.pagos.map(p => esc(p.tipo || p.forma)).join(', ')})` : ''}` : ''}
